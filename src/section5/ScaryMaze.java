...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if(mouseColor == endColor) {JOptionPane.showMessageDialog(null, "Congratulations on the Victory Royale");
	...
	private void scare() {
		...
		// AudioClip sound =
		// JApplet.newAudioClip(getClass().getResource("343823__brokenphono__high-pitch-chilling-screams.wav"));
